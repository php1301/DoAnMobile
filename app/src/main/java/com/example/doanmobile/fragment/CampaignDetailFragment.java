...
public class CampaignDetailFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        gain= Long.parseLong(GlobalVar.getInstance().getCampainSummary().get(GlobalVar.getInstance().getPosition()).getSummary().getMinimumContribution());
        ...
        Picasso.get().load(GlobalVar.getInstance().getCampainSummary().get(GlobalVar.getInstance().getPosition()).getSummary().getImage()).into(binding.imgvImgCampaign);
        binding.txtvGainEth.setText(GlobalVar.getInstance().getCampainSummary().get(GlobalVar.getInstance().getPosition()).getSummary().getMinimumContribution());
        ...
        binding.txtvTargetEth.setText("/"+GlobalVar.getInstance().getCampainSummary().get(GlobalVar.getInstance().getPosition()).getSummary().getTarget()+" ETH");
        ...
        binding.btnWithdrawal.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String url = "https://metamask.app.link/dapp/blockchain-charity.vercel.app/"+ GlobalVar.getInstance().getListDeployedCampains().getList().get(GlobalVar.getInstance().getPosition())+"/withdrawal";
